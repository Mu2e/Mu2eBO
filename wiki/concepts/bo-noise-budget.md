...
## Cross-links
- Related: [[bo-foils]], [[batch-bo]], [[scalarized-objective]], [[events-per-job-mid-flight-edit]], [[harvest-denominator-bug]], [[gp-cloud-rendering]]
...
## Open questions / TODO
- Log `model.likelihood.noise` in `botorch_predict.py` after fit so future sessions can see the GP's belief about σ directly (currently opaque).
