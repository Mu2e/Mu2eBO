...
## Cross-links
- Related: [[closed-loop-bo-design]] (existing WAL + lock-timeout design; this incident is a counterexample to "WAL + 30s timeout absorbs Ceph jitter"), [[qlnei-sob-only-picker]] (first live test, where this surfaced), [[venv-relocated-to-data-volume]] (Ceph is the underlying FS)
