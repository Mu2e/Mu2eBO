...
# row actually lands. ~15 min of stages on 8 cores. Drop to 1 x 200 for a
# 20 s/stage plumbing check that deliberately lands no row.
...
# Artifacts, before anything runs. Without this the miss surfaces three
